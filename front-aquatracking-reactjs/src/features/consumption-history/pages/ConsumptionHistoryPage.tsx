...
const ConsumptionHistoryPage = () => {
    ...
    const sensorFilteredData = selectedSensorId
        ? filteredConsumptions.map((consumption) => ({
              ...consumption,
              totalLiters:
                  consumption.bySensor.find(
                      (bs) => bs.sensorId === selectedSensorId,
                  )?.liters || 0,
          }))
    ...
    const getAnalyticMetrics = () => {
        ...
        const avgDaily =
            totalConsumption / Math.max(filteredConsumptions.length, 1)
    ...
    const getChartData = () => {
        const dataToShow = selectedSensorId
            ? sensorFilteredData
            : filteredConsumptions
        ...
        <Container>
            <div className="space-y-6">
                ...
                <div className="flex items-center justify-between animate-fade-in-down">
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">
                            Monitorea y analiza el consumo de agua de tu hogar
                        </p>
                    </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-fade-in-up animation-delay-100">
                        ...
                        <Card className="flex flex-col gap-4 bg-gradient-to-br from-gray-50 to-white border border-gray-100 rounded-3xl shadow-lg px-10 py-6">
                            ...
                            >
                                <select
                                    ...
                                    className="appearance-none px-5 py-2 pr-10 rounded-xl border border-gray-200 bg-white text-gray-800 font-semibold focus:ring-2 focus:ring-green-500 focus:border-green-500 transition text-base shadow-md"
                                    style={{ minWidth: 130 }}
                                >
                    ...
                    <Card className="p-6 min-w-[420px] min-h-[110px] flex flex-col justify-center transform transition-all duration-300 hover:shadow-lg">
                                    ...
                                    {chartData.length > 1 && (
                                        <path
                                            ...
                                            d={`M ${25},250 ${chartData
                                                ...
                                                .join(
                                                    ' ',
                                                )} L ${((chartData.length - 1) / (chartData.length - 1)) * 750 + 25},250 Z`}
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <p className="text-lg font-bold text-blue-600">
                                                            {tooltipData.consumption.toFixed(
                                                                1,
                                                            )}
                                                            L
                                                        </p>
                            ...
                            <div className="mb-1">
                                <span className="text-2xl font-bold text-gray-900">
                                    {consumptions
                                        ...
                                        ?.totalLiters.toFixed(1) || '0.0'}
                                    L
                                </span>
                            </div>
                            <div className="flex items-center text-sm">
                                <span
                                    className={`font-medium ${parseFloat(metrics.changePercent) >= 0 ? 'text-green-600' : 'text-red-600'}`}
                                >
                                            ...
                                            >
                                                ...
                                                <td className="py-4 px-4">
                                                    <span className="text-lg font-semibold text-blue-600">
                                                        {consumption.totalLiters.toFixed(
                                                            1,
                                                        )}
                                                        L
                                                    </span>
                    ...
                    {(selectedSensorId
                        ...
                        <div className="mt-4 text-center">
                            <p className="text-sm text-gray-600">
                                Mostrando los primeros 10 registros de{' '}
                                {
                                    (selectedSensorId
                                        ? sensorFilteredData
                                        : filteredConsumptions
